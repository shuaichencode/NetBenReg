...
The 'NetBenReg' package implements the methodology of net-benefit regression methods for possibly censored observational cost-effectiveness data

## Installing the 'NetBenReg' package

You can install the development version of NetBenReg using the devtools package:
